...
public class Journal {
    ...
    public void addMark(final String subjectName, final Integer newMark) {
        ...
        //student.getSubjects().compute(Subject key, (k, v) -> (v == null) ? 1 : v + 1)
//        for (final Map.Entry<Subject, Integer> map : student.getSubjects().entrySet()) {
//            if (map.getKey().getName().equals(subjectName)) {
//                map.setValue(newMark);
//            }
//        }
    }
